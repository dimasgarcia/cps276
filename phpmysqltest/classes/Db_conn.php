...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'digarcia';//this will be your WCC username
      $dbUsr = 'digarcia';//this will be your WCC username
      $dbPass = 'feA4axh4j4Ay';//this will be the password found in the video.
